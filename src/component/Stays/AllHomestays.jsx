            ...
            >
                {
                    currentHomeStays.length === 0 ? (
                        <Typography className="col-span-full text-gray-500 text-xl font-semibold">No plants found. Please try a different category or filter.</Typography>
                        ...
                        : (currentHomeStays.map((val, i) => (
                            ...
                            >
                                <Box sx={{ width: "100%", height: { xs: "200px", sm: "250px", md: "300px" }, borderRadius: "20px", objectFit: "cover", position: "relative", }}>
                                    ...
                                    />
                                    <Typography variant="body2" color="black" sx={{ position: "absolute", borderRadius: "10px", width: "100%", display: "flex", justifyContent: "end", p: 1 }}>
                                        <span className="bg-white h-8 p-1 rounded-lg font-bold">
